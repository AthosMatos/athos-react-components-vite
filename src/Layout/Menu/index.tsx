      ...
      <ATHOSMenu
        ...
        generalColors={{
          selected: {
            ...
            dark:from-pink-800 dark:to-indigo-400 dark:border-zinc-500 dark:text-zinc-200
          ...
          menu: {
            option: {
              defaults: {
                className: "text-black bg-transparent dark:text-zinc-200",
              },
              clicked: {
                className: "bg-zinc-300 border border-zinc-500 dark:bg-zinc-800 text-black dark:text-zinc-200",
              },
            },
