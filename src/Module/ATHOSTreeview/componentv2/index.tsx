...
import { buildTree, flattenTree, getChildCount, getProjection, removeChildrenOf, removeItem, setProperty } from "./utilities.ts";

import { CSS } from "@dnd-kit/utilities";
import { SortableTreeItem } from "./components/SortableTreeItem/index.tsx";
...
export function SortableTree({ collapsible, defaultItems = initialItems, indicator = false, indentationWidth = 50, removable }: Props) {
