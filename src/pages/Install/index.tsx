...
const Code = ({ children }: { children: ReactNode }) => {
  ...
  const copy = () => {
    ...
    toast("Copied to clipboard", { position: "top-right", className: "bg-green-500 text-white" });
  };
      ...
      <ATHOSTabs
        className={{
          tab: {
            ...
            active: "bg-zinc-200 dark:bg-zinc-700 text-black dark:text-zinc-200",
          },
          body: "text-black dark:text-zinc-200 bg-zinc-200 dark:bg-zinc-700",
        }}
        tabs={[
          {
            title: {
