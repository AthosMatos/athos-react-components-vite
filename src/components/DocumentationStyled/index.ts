...
const DocumentationWrapper = styled.div.attrs({
  className: "p-4 flex flex-col gap-3 rounded-lg bg-zinc-200 dark:bg-zinc-800 text-black dark:text-zinc-200",
})``;
const DocumentationPropsWrapper = styled.div.attrs({
  className: "flex flex-col gap-3 text-black dark:text-zinc-200",
})``;
